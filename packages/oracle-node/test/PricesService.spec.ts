  ...
  describe("assertSourcesNumber", () => {
    ...
    test("should not pass assertion for less than minValidSourcesPercentage", () => {
      ...
      expect(() =>
        ...
        "Invalid sources number for symbol TestToken. Valid sources count: 1, required: 2"
      );
    });
    ...
    test("should not pass assertion for zero sources", () => {
      ...
      expect(() =>
        ...
        "Invalid sources number for symbol TestToken. Valid sources count: 0, required: 2"
      );
    });
  });
});
