 ...
 */
abstract contract SinglePriceFeedsAdapterWithRounds is SinglePriceFeedAdapterBase {
   ...
   * @return latestRoundId
   */
  function getLatestRoundId() public view override returns (uint256 latestRoundId) {
    assembly {
