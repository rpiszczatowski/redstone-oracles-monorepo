...
abstract contract PrimaryProdAuthoriser is RedstoneConstants {
  function getDefaultUniqueSignersThresholdForPrimaryProd() public pure returns (uint8) {
    return 2;
  }

  function getAuthorisedSignerIndexForPrimaryProd(
